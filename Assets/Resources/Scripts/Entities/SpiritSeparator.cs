...
public class SpiritSeparator : Interactable
{
    ...
    private string[][] messages = new string[6][]
    {
        ...
        new string[] 
        {
            ...
            "Upon introducing hydrogen into the machine, the ethereal resonance intensified. The spirits became agitated, drawn closer to our realm but unable to fully manifest. When we turned the flow off, the tension lifted, yet it left a presence behind—a residual weight in the air, as though something was watching from just beyond the veil. Hydrogen seems to spark something ancient in the process."
        },
        new string[] 
        {
